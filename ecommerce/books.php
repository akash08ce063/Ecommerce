...
mysql_select_db("a5091678_ecommer");
 ...
 echo "<hr>";
              ...
              echo "<center><h2>Books</h2></center>";
 echo "<a href='nature.php'><h2>Nature Books</h2></a>";

 $sql="SELECT * FROM books_data WHERE `sub_id`=1  ORDER BY `time` DESC LIMIT 5";
 ...
 echo "<a href='hollybook.php'><h2>Holly Books</h2></a>";

 $sql="SELECT * FROM books_data WHERE `sub_id`=2  ORDER BY `time` DESC LIMIT 5";
 $res= mysql_query($sql);$a;
 echo '<table><tr>' ;
 while($row=mysql_fetch_assoc($res)){
       $result=    mysql_query("SELECT `name` FROM `books_2` WHERE `sub_id`=".$row['sub_id']."");
 ...
 echo "<hr>";
              ...
              echo "<a href='story.php'><h2>Story Books</h2></a>";

 $sql="SELECT * FROM books_data WHERE `sub_id`=3  ORDER BY `time` DESC LIMIT 5";
 $res= mysql_query($sql);$a;
 echo '<table><tr>' ;
 while($row=mysql_fetch_assoc($res)){
       $result=    mysql_query("SELECT `name` FROM `books_2` WHERE `sub_id`=".$row['sub_id']."");
 ...
 echo "<a href='education.php'><h2>Educational Books</h2></a>";

 $sql="SELECT * FROM books_data WHERE `sub_id`=4  ORDER BY `time` DESC LIMIT 5";
 $res= mysql_query($sql);$a;
 echo '<table><tr>' ;
 while($row=mysql_fetch_assoc($res)){
       $result=    mysql_query("SELECT `name` FROM `books_2` WHERE `sub_id`=".$row['sub_id']."");
